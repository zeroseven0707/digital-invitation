...
<head>
    ...
    <style>
        ...
        #qr-fab {
            ...
            border-radius: 100px;
            box-shadow: 0 8px 28px rgba(0,0,0,0.35), 0 0 0 1px rgba(212,175,55,0.15);
            cursor: pointer;
            color: #fff;
        ...
        #qr-fab:hover { transform: translateY(-2px); box-shadow: 0 12px 36px rgba(0,0,0,0.4), 0 0 0 1px rgba(212,175,55,0.25); }
        ...
        #qr-modal {
            ...
            background: linear-gradient(160deg, #1e0f38 0%, #150a28 100%);
        ...
        .qr-status.checked-in {
            background: rgba(34,197,94,.15);
            border: 1px solid rgba(34,197,94,.3);
            color: #4ade80;
        }
        .qr-status.not-checked-in {
...
<body>
        ...
        <div id="qr-modal" role="dialog" aria-modal="true" aria-label="QR Code Check-in">
            ...
            <div class="qr-body">
                ...
                <span class="qr-guest-cat">
                    @php
                        $catLabels = ['family' => 'Keluarga', 'friend' => 'Teman', 'colleague' => 'Rekan'];
                    @endphp
                ...
                <p class="qr-hint" style="margin-top:12px">
                    Tunjukkan QR ini kepada panitia saat tiba di acara untuk check-in.
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            QRCode.toCanvas(document.getElementById('qr-canvas'), QR_TOKEN, {
                width: 200,
                margin: 1,
        ...
        function handleBackdropClick(e) {
            if (e.target === document.getElementById('qr-modal-backdrop')) closeQrModal();
        }
        ...
        (function () {
            ...
            modal.addEventListener('touchend', e => {
                ...
                if (dy > 80) { modal.style.transform = ''; closeQrModal(); }

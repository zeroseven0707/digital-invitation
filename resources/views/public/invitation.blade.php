...
<body>
    {{--
        Template HTML sudah di-inject dengan:
        - QR section (floating button + modal) via partials/qr-section.blade.php
        - Gift section (hadiah) via partials/gift-section.blade.php
        Keduanya di-inject tepat sebelum </body> oleh TemplateService.
    --}}
    {!! $renderedTemplate !!}
</body>
</html>
